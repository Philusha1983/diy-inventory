...
Use this list to find specific logic, schemas, or instructions. all files are located in /Users/philipsl/Desktop/diy inventory /docs folder contains all the documentation files. for the front end use tailwindcss for inline styling. 
