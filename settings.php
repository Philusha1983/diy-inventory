...
<body class="bg-grid min-h-screen text-slate-200">
  ...
  <div id="sidebar" class="fixed inset-y-0 left-0 w-64 glass border-r border-white/5 flex flex-col z-50 -translate-x-full lg:translate-x-0 transition-transform duration-300">
    ...
    <div class="p-4 border-t border-white/5">
      ...
      <a href="dashboard.php?logout=1" class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-red-500/10 text-slate-500 hover:text-red-400 transition-colors text-sm" data-i18n="nav.logout">
  ...
  <main class="lg:ml-64 min-h-screen">
    <header class="sticky top-0 z-30 glass border-b border-white/5 px-4 lg:px-8 py-4">
      <div class="flex items-center gap-2">
        ...
        <div>
          <h1 class="text-lg lg:text-xl font-bold text-white" data-i18n-text="settings.page_title">AI Configuration</h1>
          <p class="text-xs text-slate-500 mt-0.5" data-i18n-text="settings.page_subtitle">Manage your AI provider and credentials</p>
        </div>
      </div>
    </header>
